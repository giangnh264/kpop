...
$this->menu=array(	
	array('label'=> Yii::t("admin","Thêm mới"), 'url'=>array('create'), 'visible'=>UserAccess::checkAccess('PackageOfflineCreate')),
);
$this->pageLabel = Yii::t("admin","Danh sách PackageOffline");
...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('package-offline-model-grid', {
		data: $(this).serialize()
	});
	return false;
});
...
if(Yii::app()->user->hasFlash('PackageOffline')){
    echo '<div class="flash-success">'.Yii::app()->user->getFlash('PackageOffline').'</div>';
}


$this->widget('zii.widgets.grid.CGridView', array(
	'id'=>'package-offline-model-grid',
	...
	'columns'=>array(
		...
		array(
            ...
            'header'=>CHtml::dropDownList('pageSize',$pageSize,array(10=>10,30=>30,50=>50,100=>100),array(
                                                                                  'onchange'=>"$.fn.yiiGridView.update('package-offline-model-grid',{ data:{pageSize: $(this).val() }})",
                                                                                )),
