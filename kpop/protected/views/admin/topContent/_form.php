...
$script = <<<EOD
                ...
                var link = '/index.php?r=topContent/autoComplete&t='+tc_type;
                ...
                function optType_onchange(){
                    ...
                    link = '/index.php?r=topContent/autoComplete&t='+tc_type;
                    if(tc_type != ''){
...
<div class="content-body">
	<div class="form">
			...
			if (isset($_POST['tmp_file_path']) && $_POST['tmp_file_path'] != 0) {
                $url = Yii::app()->request->baseUrl . "/data/tmp/" . $_POST['tmp_file_path'];
			} else {
		...
		<?php $form=$this->beginWidget('CActiveForm', array(
			...
			<?php echo $form->labelEx($model,'type'); ?>
                        ...
                        <select id="AdminTopContentModel_type" name="AdminTopContentModel[type]" onchange="optType_onchange()" style="background-color: lightyellow;">
                            ...
                            <option value="video_playlist">Live show</option>
                        </select>
