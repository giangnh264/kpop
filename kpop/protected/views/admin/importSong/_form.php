		...
		<div class="row global_field">
		    ...
		    <?php 
		        $this->widget('ext.xupload.XUploadWidget', array(
		                            'url' => $this->createUrl("importSong/upload", array("parent_id" => 'tmp')),
		                            'model' => $uploadModel,
		                            'attribute' => 'file',
		 ...
		 ?>
			...
			<div class="options-row">
			 ...
			 <div class="row buttons import-btn">
				<?php 
           		 echo CHtml::ajaxSubmitButton('Import',array('importSong/newImport'),
           			array(
                  		'type' => 'POST',
           				'beforeSend' => 'function(){
            			 importBefore();}',
                		'success'=>'js:'.'function(id){'.'importAfter(id);}',), 
