...
$this->pageLabel = Yii::t("admin","Danh sách RbtDownload");
...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('rbt-download-model-grid', {
		data: $(this).serialize()
	});
	return false;
});
...
if(Yii::app()->user->hasFlash('RbtDownload')){
    echo '<div class="flash-success">'.Yii::app()->user->getFlash('RbtDownload').'</div>';
}
