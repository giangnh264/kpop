...
$this->pageLabel = Yii::t("admin","Danh sách ContentLimit");
...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('admin-content-limit-model-grid', {
		data: $(this).serialize()
	});
	return false;
});
...
if(Yii::app()->user->hasFlash('ContentLimit')){
    echo '<div class="flash-success">'.Yii::app()->user->getFlash('ContentLimit').'</div>';
}


$this->widget('zii.widgets.grid.CGridView', array(
	'id'=>'admin-content-limit-model-grid',
	...
	'columns'=>array(
		...
		array(
            ...
            'header'=>CHtml::dropDownList('pageSize',$pageSize,array(10=>10,30=>30,50=>50,100=>100),array(
                                                                                  'onchange'=>"$.fn.yiiGridView.update('admin-content-limit-model-grid',{ data:{pageSize: $(this).val() }})",
                                                                                )),
