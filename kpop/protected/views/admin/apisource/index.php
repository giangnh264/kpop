...
$this->pageLabel = Yii::t("admin","Danh sách ApiSource");
...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('admin-api-source-model-grid', {
		data: $(this).serialize()
	});
	return false;
});
...
if(Yii::app()->user->hasFlash('ApiSource')){
    echo '<div class="flash-success">'.Yii::app()->user->getFlash('ApiSource').'</div>';
}


$this->widget('zii.widgets.grid.CGridView', array(
	'id'=>'admin-api-source-model-grid',
	...
	'columns'=>array(
        ...
        array(
        	'header'=>'Name',
        	'value'=>'chtml::link($data->name,Yii::app()->createUrl("apisource/view",array("id"=>$data->id)))',
        	'type'=>'raw'
        ),
        array(
        	'header'=>'Link',
        	'value'=>'chtml::link("link",$data->api_url)',
        	'type'=>'raw'
        ),
		'protocol',
		'method',
		...
		array(
            ...
            'header'=>CHtml::dropDownList('pageSize',$pageSize,array(10=>10,30=>30,50=>50,100=>100),array(
                                                                                  'onchange'=>"$.fn.yiiGridView.update('admin-api-source-model-grid',{ data:{pageSize: $(this).val() }})",
                                                                                )),
