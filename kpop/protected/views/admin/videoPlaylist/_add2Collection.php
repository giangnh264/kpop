...
$this->beginWidget('zii.widgets.jui.CJuiDialog',array(
                'id'=>'jobDialog',
                'options'=>array(
                    'title'=>Yii::t('job','Danh sách Video Playlist'),
                    'autoOpen'=>true,
                    'modal'=>'true',
                    'width'=>'650px',
                    'height'=>'auto',
    ...
    <div class="search-form" style="display:block">
		<div class="wide form">
			...
			<div class="row fl cln">
				...
				<?php echo $form->textField($videoPlaylistModel,'name',array()); ?>
			</div>
			<div class="row fl cln">
		        ...
		        <?php
	                ...
	                echo CHtml::dropDownList("AdminVideoModel[genre_id]", $videoPlaylistModel->genre_id, $category,array('class'=>'h25') ) 
	             ?>
...
$form=$this->beginWidget('CActiveForm', array(
    'action'=>Yii::app()->createUrl('videoPlaylist/add2Collection'),
    'method'=>'post',
...
$this->widget('zii.widgets.grid.CGridView', array(
	...
	'dataProvider'=>$videoPlaylistModel->search(),	
	'columns'=> $columns,
));

echo CHtml::ajaxSubmitButton(Yii::t('admin','Chọn'),CHtml::normalizeUrl(array('videoPlaylist/add2Collection','collect_id'=>$collect_id)),array('success'=>'js: function(data) {
