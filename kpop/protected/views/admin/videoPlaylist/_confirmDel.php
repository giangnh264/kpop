...
$this->beginWidget('zii.widgets.jui.CJuiDialog',array(
                'id'=>'jobDialog',
                'options'=>array(
                    'title'=>Yii::t('admin','Lý do xóa video playlist'),
                    'autoOpen'=>true,
                    'modal'=>'true',
                    'width'=>'400px',
                    'height'=>'auto',
...
?>
    ...
    <div class="row buttons pl50">
        ...
        <?php
        	if($reqsource == 'list'){
        		echo CHtml::ajaxSubmitButton(Yii::t('admin','Xóa'),CHtml::normalizeUrl(array('videoPlaylist/confirmDel','render'=>false)),array('success'=>'js: function(data) {
