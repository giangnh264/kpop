...
$this->pageLabel = Yii::t("admin","Danh sách TextLink");
...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('text-link-model-grid', {
		data: $(this).serialize()
	});
	return false;
});
...
if(Yii::app()->user->hasFlash('TextLink')){
    echo '<div class="flash-success">'.Yii::app()->user->getFlash('TextLink').'</div>';
}


$this->widget('zii.widgets.grid.CGridView', array(
	'id'=>'text-link-model-grid',
	...
	'columns'=>array(
		...
		array(
            ...
            'header'=>CHtml::dropDownList('pageSize',$pageSize,array(10=>10,30=>30,50=>50,100=>100),array(
                                                                                  'onchange'=>"$.fn.yiiGridView.update('text-link-model-grid',{ data:{pageSize: $(this).val() }})",
                                                                                )),
