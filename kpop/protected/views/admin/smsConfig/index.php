...
$this->menu=array(	
	array('label'=> Yii::t("admin","Thêm mới"), 'url'=>array('create'), 'visible'=>UserAccess::checkAccess('SmsMtModelCreate')),
);
$this->pageLabel = Yii::t("admin","Danh sách Mt");
?>
...
echo "<span id='total-selected'>0</span>";

echo '<div style="display:none">'.CHtml::checkBox ("all-item",false,array("value"=>$model->count(),"style"=>"width:30px")).'</div>';
echo '</div>';

if(Yii::app()->user->hasFlash('SmsMt')){
    echo '<div class="flash-success">'.Yii::app()->user->getFlash('SmsMt').'</div>';
}


$this->widget('zii.widgets.grid.CGridView', array(
	'id'=>'sms-mt-model-grid',
	...
	'columns'=>array(
		...
		array(
            ...
            'header'=>CHtml::dropDownList('pageSize',$pageSize,array(10=>10,30=>30,50=>50,100=>100),array(
                                                                                  'onchange'=>"$.fn.yiiGridView.update('sms-mt-model-grid',{ data:{pageSize: $(this).val() }})",
                                                                                )),
