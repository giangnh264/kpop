...
$this->pageLabel = Yii::t("admin","Danh sách RbtCollection");
...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('rbt-collection-model-grid', {
		data: $(this).serialize()
	});
	return false;
});
...
{
   $.post('".$this->createUrl('rbtCollection/reorder')."',$('.adminform').serialize(), function(data){
		...
		*/
		array(
            ...
            'header'=>CHtml::dropDownList('pageSize',$pageSize,array(10=>10,30=>30,50=>50,100=>100),array(
                                                                                  'onchange'=>"$.fn.yiiGridView.update('rbt-collection-model-grid',{ data:{pageSize: $(this).val() }})",
                                                                                )),
