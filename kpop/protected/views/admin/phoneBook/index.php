...
$this->menu=array(
		array('label'=> Yii::t("admin","Thêm mới nhiều SĐT"), 'url'=>array('create'), 'visible'=>UserAccess::checkAccess('AdminPhoneBookModelCreate')),
);
$this->pageLabel = Yii::t("admin","Danh sách thuê bao Miền Tây");
...
Yii::app()->clientScript->registerScript('search', "
		...
		$.fn.yiiGridView.update('admin-phone-book-model-grid', {
		data: $(this).serialize()
});
		return false;
});
...
<div class="title-box search-box">
	<?php echo CHtml::link(yii::t('admin','Tìm kiếm và thêm mới'),'#',array('class'=>'search-button')); ?>
</div>
...
<div class="search-form" style="display: block">
	...
	<?php $this->renderPartial('_addPhone',array(
			'model'=>$model,
)); ?>
...
if(Yii::app()->user->hasFlash('PhoneBook')){
	echo '<div class="flash-success">'.Yii::app()->user->getFlash('PhoneBook').'</div>';
}


$this->widget('zii.widgets.grid.CGridView', array(
	'id'=>'admin-phone-book-model-grid',
	...
	'columns'=>array(
		...
		array(
            ...
            'header'=>CHtml::dropDownList('pageSize',$pageSize,array(10=>10,30=>30,50=>50,100=>100),array(
                                                                                  'onchange'=>"$.fn.yiiGridView.update('admin-phone-book-model-grid',{ data:{pageSize: $(this).val() }})",
                                                                                )),
