...
$this->pageLabel = Yii::t("admin","Danh sách nhạc chờ");
...
$(document).ready(function(){
    $('.button-column a[class!=update]').hide();
});
...
if(Yii::app()->user->hasFlash('Rbt')){
    echo '<div class="flash-success">'.Yii::app()->user->getFlash('Rbt').'</div>';
}
echo '</div>';
echo $html_exp;
*/
		...
		*/
		...
		array(
            ...
            'header'=>CHtml::dropDownList('pageSize',$pageSize,array(10=>10,30=>30,50=>50,100=>100),array(
                                                                                  'onchange'=>"$.fn.yiiGridView.update('admin-rbt-model-grid',{ data:{pageSize: $(this).val() }})",
                                                                                )),
