...
<div class="fl">
	...
	<div class="row">
		<?php echo CHtml::label("Tên nhạc sỹ", "AdminVideoModel_composer_name") ?>
		<?php
		$this->widget('application.widgets.admin.ArtistAuto', array(
			...
			'fieldNameVal' => isset($_GET['AdminVideoModel']['composer_name'])?$_GET['AdminVideoModel']['composer_name']:"",
			)
		);
