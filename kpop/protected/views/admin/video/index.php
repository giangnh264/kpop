...
$this->widget('application.widgets.admin.grid.CGridView', array(
	...
	'columns'=>array(
            ...
            'class'=>'CLinkColumn',
            'header'=>'Độc quyền',
            'labelExpression'=>'($data->is_exclusive==1)?CHtml::image(Yii::app()->request->baseUrl."/css/img/publish.png"):CHtml::image(Yii::app()->request->baseUrl."/css/img/unpublish.png")',
            'urlExpression'=>'($data->is_exclusive==1)?Yii::app()->createUrl("video/unexclusive",array("cid[]"=>$data->id)):Yii::app()->createUrl("video/exclusive",array("cid[]"=>$data->id))',
            ...
            'urlExpression'=>'($data->is_new==1)?Yii::app()->createUrl("video/unnew",array("cid[]"=>$data->id)):Yii::app()->createUrl("video/new",array("cid[]"=>$data->id))',
            'linkHtmlOptions'=>array(
                                ),
                ...
                'class'=>'CLinkColumn',
                'header'=>'Lyrics',
                'labelExpression'=>'($data->videoextra->description=="")?CHtml::image(Yii::app()->request->baseUrl."/css/img/lyric.png", "#", array("id"=>$data->id)):CHtml::image(Yii::app()->request->baseUrl."/css/img/lyric_new.png", "#", array("id"=>$data->id))',
