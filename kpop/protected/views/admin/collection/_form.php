...
<div class="content-body">
	...
	<?php $form=$this->beginWidget('CActiveForm', array(
        ...
        <?php if($model->require_genre_id):?>
        <div class="row">
			<?php echo $form->labelEx($model,'Thể loại'); ?>
			<?php 
            $categoryList = AdminGenreModel::model()->gettreelist(2, false, 0, 0);
            
            $c = new CDbCriteria();
            $c->condition = "collect_id=:ID";
            $c->params = array(':ID'=>$model->id);
            $genreCate = AdminCollectionGenreModel::model()->findAll($c);
            
            $selected = CHtml::listData($genreCate, "genre_id", "genre_id");
