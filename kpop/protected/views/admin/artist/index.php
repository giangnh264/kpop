...
$html_exp = '
    <div id="expand">
        ...
        <ul id="mn-expand" style="display:none">
            <li><a href="javascript:void(0)" class="item-in-page">'. Yii::t("admin","Chọn trang này").'('.$model->search($joinRbt)->getItemCount().')</a></li>
...
$this->widget('application.widgets.admin.grid.CGridView', array(
	...
	'columns'=>array(
		...
		'album_count',
         array(
            'name'=>'Kiểu',
            'value'=>'($data->artist_type_id==0)?"Ca sỹ":(($data->artist_type_id==1)?"Nghệ sỹ":(($data->artist_type_id==2)?"Ban nhạc":"Khác"))',
         ),
		/*'created_by',
		'updated_by',
		'created_time',
