...
<div class="search-form">
    <div class="filter form fft">
        <form action="" method="get" id="viewlog">
            <input type="hidden" value="customer/log" name="r">
            ...
            <div class="row">
                ...
                <select name="type" id="t" style="vertical-align: middle;" class="textbox">
                    <optgroup label="<?php echo Yii::t('admin_customer', 'Customer info'); ?>">
                        ...
                        <option value="1" <?php if ($type == 1) echo ' selected'; ?>><?php echo Yii::t('admin', 'Nghe Nhạc'); ?></option>
                        <option value="2" <?php if ($type == 2) echo ' selected'; ?>><?php echo Yii::t('admin', 'Tải nhạc'); ?></option>
                        <option value="3" <?php if ($type == 3) echo ' selected'; ?>><?php echo Yii::t('admin', 'Xem Video'); ?></option>
                        <option value="4" <?php if ($type == 4) echo ' selected'; ?>><?php echo Yii::t('admin', 'Tải Video'); ?></option>
                    </optgroup>
                </select>
    ...
    <div class="box_content">
        <div>
            ...
            $this->widget('application.widgets.admin.grid.CGridView', array(
                ...
                'titleText' => '<h4>Lịch sử mua và tặng nội dung của thuê bao <b>' . $msisdn . '</b> từ '. $fromDate . ' đến '. $toDate.'</h4>',
                'columns' => array(
                    array(
                        'header' => 'STT',
