	...
	<?php $form=$this->beginWidget('CActiveForm', array(
		...
		<div class="row global_field">
            ...
            <select name="AdminAlbumModel[genre_id]" id="AdminAlbumModel_genre_id">
                ...
                <?php foreach($categoryList as $cat):?>
                    <?php /*<option value="<?php echo $cat['id'];?>" <?php if($cat['id']==$model->genre_id) echo 'selected';?> <?php if($cat['parent_id']==0):?>disabled="disabled" <?php endif;?>><?php echo $cat['name'];?></option>*/?>
                    <option value="<?php echo $cat['id'];?>" <?php if($cat['id']==$model->genre_id) echo 'selected';?> ><?php echo $cat['name'];?></option>
                <?php endforeach;?>
            </select>
		...
		<div class="row global_field">
			...
			<?php
	             /* $this->widget('application.widgets.admin.ArtistFeild',
	                            array(
	                             ...
	                             'fieldName'=>'AdminAlbumModel[artist_name]',
	        ...
	        if(!$model->isNewRecord){
	        	$obj = new stdClass();
	        	$obj->artist_id = $model->artist_id;
	        	$obj->artist_name = $model->artist_name;
	        	$artists[] = $obj;
	        }
			$this->widget('application.widgets.admin.artist.Feild', array(
						'fieldId' => 'artist_id',
