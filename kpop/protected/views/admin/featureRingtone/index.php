...
$this->menu=array(	
    ...
    array('label'=>'Thêm mới', 'url'=>"#", 'visible'=>UserAccess::checkAccess('FeatureRingtoneCreate'),'linkOptions'=>array('onclick'=>'popuprt()')),
);
$this->pageLabel = Yii::t("admin","Danh sách nhạc chuông chọn lọc");
...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('feature-ringtone-model-grid', {
		data: $(this).serialize()
	});
	return false;
});
...
{
   $.post('".$this->createUrl('featureRingtone/reorder')."',$('.adminform').serialize(), function(data){
        alert('Cập nhật thành công')
   });
}
window.popuprt = function(){
	jQuery.ajax({
	  'onclick':'$(\"#jobDialog\").dialog(\"open\"); return false;',
	  'url':'". $this->createUrl("ringtone/list")."',
	  'type':'GET',
	  'cache':false,
...
if(Yii::app()->user->hasFlash('FeatureRingtone')){
    echo '<div class="flash-success">'.Yii::app()->user->getFlash('FeatureRingtone').'</div>';
}


$this->widget('zii.widgets.grid.CGridView', array(
	'id'=>'feature-ringtone-model-grid',
	...
	'columns'=>array(
		...
		array(
            ...
            array(
        		'header'=>'CP',
        		'value' => '$data->rt->cpt->name'
        ),
              array(
        		'header'=>'Category',
        		'value' => '$data->rt->rt_cat->name'
        ),
        ...
        array(
            ...
            'urlExpression'=>'($data->status==1)?Yii::app()->createUrl("featureRingtone/unpublish",array("cid[]"=>$data->id)):Yii::app()->createUrl("featureRingtone/publish",array("cid[]"=>$data->id))',
		...
		array(
            ...
            'header'=>CHtml::dropDownList('pageSize',$pageSize,array(10=>10,30=>30,50=>50,100=>100),array(
                                                                                  'onchange'=>"$.fn.yiiGridView.update('admin-feature-rt-model-grid',{ data:{pageSize: $(this).val() }})",
                                                                                )),
...
//			'class'=>'CButtonColumn',
//            'header'=>CHtml::dropDownList('pageSize',$pageSize,array(10=>10,30=>30,50=>50,100=>100),array(
//                                                                                  'onchange'=>"$.fn.yiiGridView.update('feature-ringtone-model-grid',{ data:{pageSize: $(this).val() }})",
//                                                                                )),
//
//
//		),
