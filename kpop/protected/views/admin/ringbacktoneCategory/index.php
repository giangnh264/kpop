...
$this->pageLabel = Yii::t('admin','Thể loại nhạc chờ'); 
...
$this->widget('zii.widgets.grid.CGridView', array(
	'id'=>'admin-rbt-category-model-grid',
		...
		*/
		...
		array(
            ...
            'header'=>CHtml::dropDownList('pageSize',$pageSize,array(10=>10,30=>30,50=>50,100=>100),array(
                                                                                  'onchange'=>"$.fn.yiiGridView.update('admin-rbt-category-model-grid',{ data:{pageSize: $(this).val() }})",
                                                                                )),
