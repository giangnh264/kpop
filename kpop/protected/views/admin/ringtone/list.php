...
$this->beginWidget('zii.widgets.jui.CJuiDialog',array(
                'id'=>'jobDialog',
                'options'=>array(
                    'title'=>Yii::t('job','Danh sách nhạc chuông đã duyệt'),
                    'autoOpen'=>true,
                    'modal'=>'true',
                    'width'=>'650px',
                    'height'=>'auto',
...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('admin-rt-model-grid', {
		data: $(this).serialize()
	});
	return false;
});
...
$this->widget('zii.widgets.grid.CGridView', array(
	'id'=>'admin-rt-model-grid',
	'dataProvider'=>$model->search(),	
	'columns'=> $columns,
));
   
    echo CHtml::ajaxSubmitButton(Yii::t('admin','Chọn'),CHtml::normalizeUrl(array('ringtone/list','render'=>false)),array('success'=>'js: function(data) {
