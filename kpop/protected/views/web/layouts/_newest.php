            ...
            <div class="col-lg-12 col-md-12">
                <div class="row">
                    ...
                    <div class="col-lg-2 col-md-2">
                        ...
                        <h4 class="h6"><a href="<?php echo Yii::app()->createUrl('news/index', array('id'=>$item->id, 'url_key'=>Common::makeFriendlyUrl($item->title)));?>"><?php echo Formatter::smartCut($item->title, 80, 0); ?></a></h4></div>
                   <?php endforeach;?>
                </div>
            </div>
        </div>
