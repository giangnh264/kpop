...
class GenreController extends Controller {
    ...
    public function actionIndex() {
         ...
         */
		$type = $_GET['AdminGenreModel']['type'];
        $treeData = AdminGenreModel::model()->gettreelist(1,false,0,1,true,$type);
//        $treeData = AdminGenreModel::model()->gettreelist(1);
	...
	public function actionGetGenreByType()
	{
		$this->layout=false;
		$type = Yii::app()->request->getParam('type', '');
		$genreParentId = Yii::app()->request->getParam('id', '');
		$categoryList = AdminGenreModel::model()->gettreelist(2, false, 0, 1, false, $type);
		$category = CMap::mergeArray(
				array('0'=> "  "),
				CHtml::listData($categoryList, 'id', 'name')
		);
		echo CHtml::dropDownList("AdminGenreModel[parent_id]", $genreParentId, $category);
		exit;
	}
    /**
