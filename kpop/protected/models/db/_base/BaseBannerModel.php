...
class BaseBannerModel extends MainActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('apply_user, width, height, log_click, rate, status, sorder', 'numerical', 'integerOnly'=>true),
			...
			array('id, type, channel, name, url, position, start_time, expired_time, image_file, params, apply_user, width, height, log_click, rate, status, sorder', 'safe', 'on'=>'search'),
		);
	}
