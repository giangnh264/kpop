...
/**
 * This is the model class for table "ringtone_deleted".
 *
 * The followings are the available columns in table 'ringtone_deleted':
 * @property string $ringtone_id
 * @property integer $deleted_by
 * @property string $deleted_reason
 * @property string $deleted_time
 */
class BaseRingtoneDeletedModel extends MainActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return RingtoneDeleted the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('ringtone_id', 'length', 'max'=>10),
			array('deleted_reason', 'length', 'max'=>255),
			array('deleted_time', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('ringtone_id, deleted_by, deleted_reason, deleted_time', 'safe', 'on'=>'search'),
		);
	}
