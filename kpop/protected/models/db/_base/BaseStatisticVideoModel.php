...
class BaseStatisticVideoModel extends MainActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('genre_id, cp_id, played_count_wap, played_count_api_ios, played_count_api_android, downloaded_count_web, downloaded_count_wap, downloaded_count_api_ios, downloaded_count_api_android', 'numerical', 'integerOnly'=>true),
