...
class BaseNewsEventModel extends MainActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('object_id, sorder, is_web_slidebar', 'numerical', 'integerOnly'=>true),
			...
			array('id, name, type, object_id, sorder, custom_link, channel, content, is_web_slidebar, created_time, updated_time', 'safe', 'on'=>'search'),
		);
	}
