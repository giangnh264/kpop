 ...
 */
class BasePhoneBookModel extends MainActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            ...
            array('group_code', 'length', 'max' => 10),
            array('group_name', 'length', 'max' => 150),
            array('created_time', 'safe'),
            // The following rule is used by search().
            // Please remove those attributes that should not be searched.
            array('id, phone, group_code, group_name, created_time', 'safe', 'on' => 'search'),
        );
    }
