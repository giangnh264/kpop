...
/**
 * This is the model class for table "top_song_week".
 *
 * The followings are the available columns in table 'top_song_week':
 * @property integer $id
 ...
 */
class BaseTopSongWeekModel extends MainActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('song_data, artist_data', 'required'),
