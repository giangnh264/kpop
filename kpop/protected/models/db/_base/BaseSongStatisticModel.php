...
/**
 * This is the model class for table "song_statistic".
 *
 * The followings are the available columns in table 'song_statistic':
 * @property string $song_id
 * @property string $old_id
 * @property string $played_count
 * @property string $downloaded_count
 */
class BaseSongStatisticModel extends MainActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('song_id, old_id, played_count, downloaded_count', 'length', 'max'=>10),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('song_id, old_id, played_count, downloaded_count', 'safe', 'on'=>'search'),
		);
	}
