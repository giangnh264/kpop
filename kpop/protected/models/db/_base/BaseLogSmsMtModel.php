...
class BaseLogSmsMtModel extends MainActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('sms_type, charge, log_status', 'numerical', 'integerOnly'=>true),
			...
			array('id, service_number, sms_id, receive_phone, send_datetime, sms_type, content, description, charge, service_name, status, log_status', 'safe', 'on'=>'search'),
		);
	}
