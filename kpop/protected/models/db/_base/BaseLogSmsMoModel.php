...
class BaseLogSmsMoModel extends MainActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('output_id, log_status', 'numerical', 'integerOnly'=>true),
			...
			array('id, service_number, sms_id, sender_phone, receive_time, keyword, content, auth_user, auth_pass, output_id, status, log_status', 'safe', 'on'=>'search'),
		);
	}
