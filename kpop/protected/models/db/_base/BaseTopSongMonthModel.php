...
/**
 * This is the model class for table "top_song_month".
 *
 * The followings are the available columns in table 'top_song_month':
 * @property integer $id
 ...
 */
class BaseTopSongMonthModel extends MainActiveRecord
{
	/**
