...
/**
 * This is the model class for table "top_video_day".
 *
 * The followings are the available columns in table 'top_video_day':
 * @property integer $id
 ...
 */
class BaseTopVideoDayModel extends MainActiveRecord
{
	/**
