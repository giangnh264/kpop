...
/**
 * This is the model class for table "user_transaction_copy".
 *
 * The followings are the available columns in table 'user_transaction_copy':
 * @property string $id
 ...
 */
class BaseUserTransactionCopyModel extends MainActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return UserTransactionCopy the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, old_id, user_id, user_phone, transaction, channel, old_obj_id, obj1_id, obj1_name, obj1_url_key, obj2_id, obj2_name, obj2_url_key, package_id, cp_id, cp_name, genre_id, sharing_rate, price, promotion, note, return_code, created_time', 'safe', 'on'=>'search'),
		);
	}
