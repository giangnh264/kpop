...
/**
 * This is the model class for table "ads_marketing".
 *
 * The followings are the available columns in table 'ads_marketing':
 * @property integer $id
 ...
 */
class BaseAdsMarketingModel extends MainActiveRecord
{
	/**
