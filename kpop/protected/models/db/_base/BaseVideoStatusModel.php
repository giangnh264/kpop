...
class BaseVideoStatusModel extends MainActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('convert_status, approve_status, artist_status', 'numerical', 'integerOnly'=>true),
			array('video_id, artist_id', 'length', 'max'=>10),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('video_id, convert_status, approve_status, artist_status, artist_id', 'safe', 'on'=>'search'),
		);
	}
