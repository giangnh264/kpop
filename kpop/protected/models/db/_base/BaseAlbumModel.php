...
class BaseAlbumModel extends MainContentModel
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('genre_id, song_count, price, created_by, approved_by, updated_by, cp_id, suggest_1, suggest_2, sorder, status, sync_status, merge_status, exclusive, new_release', 'numerical', 'integerOnly'=>true),
			array('old_id, artist_id', 'length', 'max'=>10),
			...
			array('published_date, description, created_time, active_fromtime, active_totime', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, old_id, name, url_key, genre_id, artist_id, artist_name, song_count, price, publisher, published_date, description, created_by, approved_by, updated_by, cp_id, suggest_1, suggest_2, created_time, updated_time, sorder, status, sync_status, merge_status, exclusive, new_release, cmc_id, onlyone, active_fromtime, active_totime', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('new_release',$this->new_release);
