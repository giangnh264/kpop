 ...
 *
 * The followings are the available columns in table 'video_statistic':
 * @property integer $video_id
 * @property string $old_id
 * @property string $played_count
 * @property string $downloaded_count
 */
class BaseVideoStatisticModel extends MainActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('played_count, downloaded_count', 'length', 'max'=>11),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('video_id, old_id, played_count, downloaded_count', 'safe', 'on'=>'search'),
		);
	}
