...
/**
 * This is the model class for table "album_deleted".
 *
 * The followings are the available columns in table 'album_deleted':
 * @property string $album_id
 * @property integer $deleted_by
 * @property string $deleted_reason
 * @property string $deleted_time
 */
class BaseAlbumDeletedModel extends MainActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return AlbumDeleted the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('album_id, deleted_by, deleted_reason, deleted_time', 'safe', 'on'=>'search'),
		);
	}
