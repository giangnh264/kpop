...
/**
 * This is the model class for table "top_video_month".
 *
 * The followings are the available columns in table 'top_video_month':
 * @property integer $id
 ...
 */
class BaseTopVideoMonthModel extends MainActiveRecord
{
	/**
