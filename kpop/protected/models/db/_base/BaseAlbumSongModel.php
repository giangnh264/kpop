...
class BaseAlbumSongModel extends MainActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('song_id, album_id, album_old_id, song_old_id', 'length', 'max'=>10),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, song_id, album_id, album_old_id, song_old_id, status, sorder', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('song_old_id',$this->song_old_id,true);
