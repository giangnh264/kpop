...
class BaseArtistFanModel extends MainActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('artist_id, user_old_id, user_id', 'length', 'max'=>10),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, artist_id, user_old_id, user_id, created_time', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('user_old_id',$this->user_old_id,true);
