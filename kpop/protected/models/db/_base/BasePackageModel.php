 ...
 * @property string $vina_service_code
 * @property double $fee
...
class BasePackageModel extends MainActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('duration, bundle, sorder, status', 'numerical', 'integerOnly'=>true),
			...
			array('vina_service_code', 'length', 'max'=>30),
			...
			array('id, code, name, vina_service_code, fee, duration, owner, bundle, price_song_streaming, price_video_streaming, price_song_download, price_video_download, price_ringtone_download, description, promotion_desc, sms_short_code, sms_command_code, sorder, status', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('vina_service_code',$this->vina_service_code,true);
