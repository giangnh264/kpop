...
/**
 * This is the model class for table "video_deleted".
 *
 * The followings are the available columns in table 'video_deleted':
 * @property string $video_id
 * @property integer $deleted_by
 * @property string $deleted_reason
 * @property string $deleted_time
 */
class BaseVideoDeletedModel extends MainActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return VideoDeleted the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('video_id, deleted_by, deleted_reason, deleted_time', 'safe', 'on'=>'search'),
		);
	}
