...
class BaseUserSubscribeModel extends MainActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('user_id, package_id, bundle, extended_retry_times, retry_on_day, status', 'numerical', 'integerOnly'=>true),
			array('old_id, extended_count', 'length', 'max'=>10),
			...
			array('id, user_id, old_id, user_phone, package_id, bundle, source, event, extended_count, extended_retry_times, last_retry_time, retry_on_day, created_time, extended_time, expired_time, updated_time, last_subscribe_time, last_unsubscribe_time, last_action, status', 'safe', 'on'=>'search'),
		);
	}
