...
/**
 * This is the model class for table "ringtone_status".
 *
 * The followings are the available columns in table 'ringtone_status':
 * @property string $ringtone_id
 * @property integer $convert_status
 * @property integer $approve_status
 */
class BaseRingtoneStatusModel extends MainActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('ringtone_id, convert_status, approve_status', 'safe', 'on'=>'search'),
		);
	}
