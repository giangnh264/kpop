...
try {
    ...
    var Posts = {
        crawl: function () {
            connection.query('SELECT * FROM original_url WHERE crawler_status = 0 ORDER BY updated_time ASC LIMIT 100', function (error, results) {
            ...
            jsdom.env({
                ...
                src: [jquery],
                    ...
                    if (typeof window === 'object') {
                        ...
                        // var content = sanitizeHtml(mainContent.find(".content-news-detail").text(), {
